...
export default class Select implements Component {
  ...
  constructor ({ title, required, getValue, setValue, options, id }: { title: string, required: boolean, getValue: any, setValue: any, options: Array<{ value: string, label: string }>, id?: string }) {
    this.title = title
